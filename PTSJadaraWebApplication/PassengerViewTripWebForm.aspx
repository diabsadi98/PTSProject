<%@ Page Title="" Language="C#" MasterPageFile="~/PassengerMaster.Master" AutoEventWireup="true" CodeBehind="PassengerViewTripWebForm.aspx.cs" Inherits="PTSJadaraWebApplication.PassengerViewTripWebForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <table class="auto-style1">
        ...
        <tr>
            <td class="auto-style2">&nbsp;</td>
            <td>
                <asp:Image ID="ImageQR" runat="server" Height="150px" Width="150px" />
            </td>
        </tr>
        <tr>
            <td class="auto-style2">&nbsp;</td>
