...
{
    public partial class AdminUpdateTripWebForm : System.Web.UI.Page
    {
                                        ...
                                        else
                                        {
                                            ...
                                            else
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    if (trips.UpdateTrip(DropDownListFromCity.SelectedItem.ToString(), DropDownListToCity.SelectedItem.ToString(), TextBoxPassengerNo.Text, TextBoxAdultPrice.Text, TextBoxChildPrice.Text, DropDownListStartTime.SelectedItem.ToString(), DropDownListEndTime.SelectedItem.ToString(), Convert.ToDateTime(TextBoxTripDate.Text).ToString("yyyy-MM-dd"), DropDownListDriverName.SelectedValue.ToString(), Session["Username"].ToString(), TripID) > 0)
                                                    {
                                                       
                                                        Response.Redirect("AdminUpdateTripWebForm.aspx");
                                                    }
                                                    else
                                                    {
        ...
        {
            Trips trips = new Trips();
            GridViewTrips.DataSource = trips.GetTripsByDate(TextBoxTripDate1.Text);
